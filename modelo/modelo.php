...
class Juguete
{
    ...
    {
        $sql = "INSERT INTO juguetes() VALUES( default,'{$nombre}', '{$precio}', '{$proveedor}', '{$descuento}', '../img/{$imagen}')";
    ...
    {
        $sql = "UPDATE juguetes SET nombre='$nombre',precio='$precio',proveedor='$proveedor',descuento='$descuento',imagen='../img/$imagen' where id = {$id}";
        $result = $this->dbc->query($sql);
        $this->dbc = null;
        return $result;
    }
