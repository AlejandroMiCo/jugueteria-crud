...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-center">
            ...
            <form class="bg-white p-3 bg-opacity-10 rounded-3" action="../controladores/controlador_actualizar.php" method="post">
                ...
                <div class="form mb-3">
                    ...
                    <input type="file" class="form-control" id="imagen" name="imagen" value="<?php echo $datos['imagen'] ?>">
                </div>
                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"><br>
                <div class="d-flex justify-content-end">
                    <a href="../controladores/controlador.php" type="button" class="btn btn-outline-danger me-2">Regresar</a>
                    <button type="submit" class="btn btn-primary" value="Actualizar">Actualizar juguete</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="toastSuccessUpdate" class="toast text-white bg-success position-fixed top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="d-flex">
            <div class="toast-body">
                Juguete actualizado correctamente
            </div>
